...
function buildRegex() {
    ...
    const minSpecialChars = config.validation.password.minSpecialChar;
    const allowedSpecialChars = config.validation.password.allowedSpecialChars.join('\\'); // escape all characters
